$(document).ready(function(){
  ...
  function createControls() {
    ...
    html += " to <input class=dt_input id=ts_edate type=text maxlength=10>";
    html += "&nbsp;&nbsp;TIME:&nbsp;<input class=dt_input id=ts_stime type=text maxlength=8>";
    html += " to <input class=dt_input id=ts_etime type=text maxlength=8>";
  ...
  $('.content-right,.rl').css('margin-top','1px');
  $('.content-left').css('top','40px'); 
