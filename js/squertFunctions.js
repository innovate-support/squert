...
function getTimestamp() {
  ...
  var tl = "<div class=ctt><span class=fl>Time Interval in View: </span><span class=" + fbt_c + " data-ft=tl>";
  tl += ts_sd + " " + ts_st + " -> " + ts_ed + " " + ts_et + " (" + ts_os + ")";
  tl += "</span></div>";
  tl += "<span class=fl>Filtered by classification: </span><span class=" + fval_c + " data-ft=ob>" + fval + "</span>";
  ...
  // k33, k34, k35 are custom lines by Kris
  var k33 = "<span class=" + fval_c + " data-ft=ob>" + fval + "</span>";
     $('.class_filter').html(k33);

  var k34 = "<span class=" + fbs_c + " data-ft=sn>" + fbs + "</span>";
     $('.sensor_filter').html(k34);

  var k35 = "<span class=" + fbt_c + " data-ft=tl>";
     k35 += ts_sd + " " + ts_st + " -> " + ts_ed + " " + ts_et + " ";
     k35 += "</span>";
     $('.time_filter').html(k35);
...
function mkPribar(v) {
  ...
  // k36, k37, k38, k39, k40 custom lines by Kris
  var k40 = [];
  if ( sum > 0) {
    k40 = [Number(v[0]/sum*100).toFixed(1),Number(v[1]/sum*100).toFixed(1),
         Number(v[2]/sum*100).toFixed(1),Number(v[3]/sum*100).toFixed(1)];
    var k36 = "<table class=pribar><tr>";
    var k37 = ['High Priority','Medium Priority','Low Priority','Other'];
    for (var k39=1; k39<5;k39++) {
      var k38 = Number(k39 - 1);
      if (k40[k38] > 0) { 
        k36 += "<td data-pr=" + k39 + " class=bpr" + k39 + " width=" + k40[k38] + "% title=\""; 
        k36 += k37[k38] + ": " + v[k38] + "\">" + k40[k38] + "%</td>";
        $('#pr_' + k39).html(v[k38] + "<span class=per>(" + k40[k38] + "%)</span>");
      }  
    } 
  } else {
    k36 += "<td>-</td>";
